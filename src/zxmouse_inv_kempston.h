#pragma once
#ifndef ZXMOUSE_INV_KEMPSTON_H
#define ZXMOUSE_INV_KEMPSTON_H
...
class ZxInvKempstonMouse final:
    public ZxMouse,
    public fg::artifact<ZxInvKempstonMouse, "Kempston (inv. buttons)"_art_kind, ZxMouse>,
    public event::handler<ZxInvKempstonMouse, EVENT::Z80_IO_IN> {
